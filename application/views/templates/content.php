            ...
            <div class="container <?php echo $section['class_gallery_container']; ?>">
                ...
                <div class="row content-center <?php echo $section['class_gallery_row'] ?> ">
                    ...
                    <div class="col-lg-12 col-md-12 ">
                        <?php if($section['display_title_section'] == '1'): ?>
                        <?php   if($use_tinymce == 0): ?>
                            <h1 class="<?php echo $section['wow'];?> <?php echo $section['animate'];?>"><?php echo $section['section_title']; ?></h1>
                        <?php   else: ?>
                            <div class="<?php echo $section['wow'];?> <?php echo $section['animate'];?>"><?php echo $section['section_title']; ?></div>
                        <?php   endif; ?>
                        <?php endif; ?>
                    </div>
                    <!-- /section title -->
                    ...
                    <!-- IF section layout slider content -->
                    <?php elseif($section['section_layout'] == '7'): ?>

                        <?php $this->load->view('templates/layout/section_layout_7', Array('sid' => $section['sid']));?>
